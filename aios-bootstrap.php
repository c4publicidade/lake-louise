...
if (file_exists('/home2/lakelo53/public_html/wordfence-waf.php')) {
	include_once('/home2/lakelo53/public_html/wordfence-waf.php');
}
$GLOBALS['aiowps_firewall_rules_path'] = __DIR__.'/wp-content/uploads/aios/firewall-rules/';

$GLOBALS['aiowps_firewall_data'] = array(
	'ABSPATH' => '/home2/lakelo53/public_html/',
);
